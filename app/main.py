...
from app.routers import natal_chart_router, synastry_router, daily_weekly_transits_router, moon_solar_router, synastry_pdf_router, enhanced_svg_router, transit_router, composite_chart_router
...
app.include_router(enhanced_svg_router.router) # Adicionando o router SVG aprimorado (v2)
app.include_router(transit_router.router) # Adicionando o router de trânsitos
app.include_router(composite_chart_router.router) # Adicionando o router de mapa composto
